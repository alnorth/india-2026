...
export default async function Home() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Journey Overview</h2>
